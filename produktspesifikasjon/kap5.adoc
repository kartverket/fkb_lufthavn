// Start of UML-model
=== Pakke: «ApplicationSchema» FKB-Lufthavn-5.0.1
...
.Hoveddiagram FKB-Lufthavn-5.0.1 
image::diagrammer/Hoveddiagram FKB-Lufthavn-5.0.1.png[link=diagrammer/Hoveddiagram FKB-Lufthavn-5.0.1.png, alt="Diagram med navn Hoveddiagram FKB-Lufthavn-5.0.1 som viser UML-klasser beskrevet i teksten nedenfor."]
